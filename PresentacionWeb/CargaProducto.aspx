   ...
   <div class="row">
    <form class="col s12" runat="server">
      <div class="row">
        ...
        <asp:TextBox ID="txtDescripcion" ClientIDMode="Static" Name="txtDescripcion" CssClass="validate" type="text" runat="server" />
          <label for="txtDescripcion">Producto</label>
        </div>
       <div class="input-field col s6">
        <asp:TextBox ID="txtStockActual" ClientIDMode="Static" CssClass="validate" type="text" runat="server" />
